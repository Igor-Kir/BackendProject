...
public class XlReader {
    ...
    public static List<University> readXlUniversities(String filePath) throws IOException {
    ...
    public static List<Student> readXlStudents(String filePath) throws IOException {
